document.addEventListener('DOMContentLoaded', function () {
    ...
    var dziUrl = `./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/${slideId}.dzi`;
...
function fetchAndApplyOverlay(viewer) {
    ...
    fetch(`./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/${slideId}.svg`)
