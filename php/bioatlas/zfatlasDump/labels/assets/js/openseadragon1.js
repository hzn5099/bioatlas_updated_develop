...
if (slideId == '35532') {
    document.addEventListener('DOMContentLoaded', function () {
        const viewer = OpenSeadragon({
            ...
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/1727.dzi",
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/20_1727_10-3dpfC10can.svg")
...
} else if (slideId == '35537')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/1731.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/20_1731_3-3dpfC3can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
} else if (slideId == '35536')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/1728.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/20_1728_11-3dpfC11can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
} else if (slideId == '493')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/493.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/21_493_7-3dpfS7can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
} else if (slideId == '494')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/494.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/21_494_12-3dfS12can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
} else if (slideId == '496')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/496.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/21_496_11-3dpfS11can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
} else if (slideId == '282')
{
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/22_282_3-3dpfT1can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
}else if (slideId == '285')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/285.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/22_285_4-3dpfT4can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
}else if (slideId == '291')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/291.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/22_291_10-3dpfT10can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
}else if (slideId == '293')
{
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/293.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/22_293_12-3dpfT12can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
...
}else if (slideId == '306')
{
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const viewer = OpenSeadragon({
            id: "openseadragon1",
            prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
            tileSources: "./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/dzi_output/306.dzi",
            showNavigationControl: false,
            minZoomImageRatio: 0.4,
            showNavigator: true,
        });
    ...
    function fetchAndApplyOverlay(viewer) {
        fetch("./assets/EC2/output/anatomical_reference_histology_zf/Coronal_3dpf_svg/22_306_25-3dpfT25can.svg")
            .then(response => response.text())
            .then(svg => {
                var svgOverlay = document.createElement("div");
                svgOverlay.innerHTML = svg;
